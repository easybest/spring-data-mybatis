...
package io.easybest.mybatis.build.optional;
...
public class OptionalDependenciesPlugin implements Plugin<Project> {
	...
	public void apply(Project project) {
		...
		project.getPlugins().withType(EclipsePlugin.class, eclipsePlugin -> project.getExtensions()
				.getByType(EclipseModel.class).classpath(classpath -> classpath.getPlusConfigurations().add(optional)));
	}
