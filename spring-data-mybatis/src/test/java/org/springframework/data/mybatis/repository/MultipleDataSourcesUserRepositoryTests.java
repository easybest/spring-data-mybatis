...
public class MultipleDataSourcesUserRepositoryTests extends UserRepositoryTests {

	@Configuration
	@ImportResource("classpath:infrastructure-multiple-ds.xml")
	static class Config {
		...
		public UserRepository userRepository() {
			...
			factory.setSupportMultipleDatasources(true);
	...
	@EnableMybatisRepositories(basePackageClasses = UserRepository.class, supportMultipleDatasources = true)
