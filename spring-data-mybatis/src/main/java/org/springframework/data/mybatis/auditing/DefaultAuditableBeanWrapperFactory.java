...
class DefaultAuditableBeanWrapperFactory implements AuditableBeanWrapperFactory {
	...
	static class AuditableInterfaceBeanWrapper extends
			DateConvertingAuditableBeanWrapper<Auditable<Object, ?, TemporalAccessor>> {
		...
		public TemporalAccessor setCreatedDate(TemporalAccessor value) {
			...
			auditable.setCreatedDate(getAsTemporalAccessor(Optional.of(value), type)
		 ...
		 * (non-Javadoc)
		 *
		 * @see org.springframework.data.auditing.DefaultAuditableBeanWrapperFactory.
		 * AuditableInterfaceBeanWrapper#setLastModifiedBy(java.util.Optional)
		 */
		@Override
		...
		public Optional<TemporalAccessor> getLastModifiedDate() {
			return getAsTemporalAccessor(auditable.getLastModifiedDate(),
		...
		public TemporalAccessor setLastModifiedDate(TemporalAccessor value) {
			...
			auditable.setLastModifiedDate(getAsTemporalAccessor(Optional.of(value), type)
					.orElseThrow(IllegalStateException::new));
	...
	abstract static class DateConvertingAuditableBeanWrapper<T>
		 ...
		 */
		@Nullable
		protected Object getDateValueToSet(TemporalAccessor value, Class<?> targetType,
				Object source) {
		 ...
		 */
		@SuppressWarnings("unchecked")
		protected <S extends TemporalAccessor> Optional<S> getAsTemporalAccessor(
				Optional<?> source, Class<? extends S> target) {
			...
			return source.map(it -> {
				...
				Class<?> typeToConvertTo = Stream.of(target, Instant.class)//
						...
						.findFirst() //
						.orElseThrow(() -> rejectUnsupportedType(
								source.map(Object.class::cast).orElseGet(() -> source)));
