 ...
 * @since 2.0.2
 */
public class DialectFactoryBean extends AbstractFactoryBean<Dialect> {
	...
	@Override
	protected Dialect createInstance() throws Exception {
		return StandardDialectResolver.INSTANCE.resolveDialect(new DatabaseMetaDataDialectResolutionInfoAdapter(
				this.sqlSessionTemplate.getConfiguration().getEnvironment().getDataSource()));
	}
