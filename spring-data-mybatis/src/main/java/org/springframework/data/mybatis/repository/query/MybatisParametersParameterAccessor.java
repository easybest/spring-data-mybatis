...
/**
 * {@link org.springframework.data.repository.query.ParameterAccessor} based on an
 * {@link Parameters} instance. It also offers access to all the values, not just the
 * bindable ones based on a {@link MybatisParameters.MybatisParameter} instance.
 *
 * @author JARVIS SONG
 * @since 2.0.0
 */
