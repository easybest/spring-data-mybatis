 ...
 * @since 2.0.2
 */
public class OneToManyAssociation extends Association implements Serializable {

	private static final long serialVersionUID = 4730040714416090697L;

	protected final ForeignKey foreignKey;

	public OneToManyAssociation(MybatisPersistentProperty property, Domain self, Domain target) {
