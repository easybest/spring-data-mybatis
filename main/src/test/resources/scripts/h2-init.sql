...
(
	first1  bigint  not null,
	second1 bigint  not null,
	isNew   boolean not null,
	primary key (first1, second1)
);
...
(
	first1          bigint not null,
	second1_otherId bigint not null,
	primary key (first1, second1_otherId)
);
